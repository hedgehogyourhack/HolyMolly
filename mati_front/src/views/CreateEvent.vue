                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-6 p-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control description" rows="5" id="edescription"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="etags">Event tags:</label>
                            <input type="number" class="form-control" id="etags" placeholder="Event name" name="etags"
                                   required>
                        </div>
                        <div class="form-group">
